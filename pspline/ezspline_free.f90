...
subroutine EZspline_free1_r8(spline_o, ier)
  ...
  nullify(spline_o%x1)
  nullify(spline_o%fspl)
  nullify(spline_o%x1pkg)
...
subroutine EZspline_free2_r8(spline_o, ier)
  ...
  nullify(spline_o%x2)
  nullify(spline_o%fspl)
  nullify(spline_o%bcval1min)
  nullify(spline_o%bcval1max)
  nullify(spline_o%bcval2min)
  nullify(spline_o%bcval2max)
  nullify(spline_o%x1pkg)
  nullify(spline_o%x2pkg)
...
subroutine EZspline_free3_r8(spline_o, ier)
  ...
  nullify(spline_o%bcval2min)
  nullify(spline_o%bcval2max)
  nullify(spline_o%bcval3min)
  nullify(spline_o%bcval3max)
  nullify(spline_o%x1pkg)
  nullify(spline_o%x2pkg)
  nullify(spline_o%x3pkg)
