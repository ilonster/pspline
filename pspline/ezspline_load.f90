...
!  are recalculated.
   ...
   subroutine EZspline_load1_r8(spline_o, filename, ier, spl_name)
     ...
     if( spline_o%isAllocated == 1 ) call EZspline_free1_r8(spline_o, ier)
     ...
     call cdfGetVar(ncid, trim(zpre)//'isInitialized', spline_o%isInitialized, ifail)
     call cdfGetVar(ncid, trim(zpre)//'isAllocated', spline_o%isAllocated, ifail)
...
!!
   ...
   subroutine EZspline_load2_r8(spline_o, filename, ier, spl_name)
     ...
     if( spline_o%isAllocated == 1 ) call EZspline_free2_r8(spline_o, ier)
...
!!!
   ...
   subroutine EZspline_load3_r8(spline_o, filename, ier, spl_name)
     ...
     if( spline_o%isAllocated == 1 ) call EZspline_free3_r8(spline_o, ier)
...
!
   ...
   subroutine EZspline_load1_r4(spline_o, filename, ier, spl_name)
     ...
     if( spline_o%isAllocated == 1 ) call EZspline_free1_r4(spline_o, ier)
...
!!
   ...
   subroutine EZspline_load2_r4(spline_o, filename, ier, spl_name)
     ...
     if( spline_o%isAllocated == 1 ) call EZspline_free2_r4(spline_o, ier)
...
!!!
   ...
   subroutine EZspline_load3_r4(spline_o, filename, ier, spl_name)
     ...
     if( spline_o%isAllocated == 1 ) call EZspline_free3_r4(spline_o, ier)
