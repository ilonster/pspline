...
!
   ...
   subroutine EZspline_save1_r8(spline_o, filename, ier, &
     ...
     call ezspline_defVar(ncid, trim(zpre)//'isInitialized', dimlens, int, imodify, ier)
     call ezspline_defVar(ncid, trim(zpre)//'isAllocated', dimlens, int, imodify, ier)
     ...
     call cdfPutVar(ncid, trim(zpre)//'isInitialized', spline_o%isInitialized, ifail)
     call cdfPutVar(ncid, trim(zpre)//'isAllocated', spline_o%isAllocated, ifail)
