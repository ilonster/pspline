...
c
      ier=0
c
      if((jspline(1).ge.1).and.(nx.lt.4)) then
         write(6,*) ' ?vecintrp3d:  nx.lt.4:  nx = ',nx,
     >        'with jspline(1)=',jspline(1)
         ier=1
      endif
c
      if((jspline(2).ge.1).and.(ny.lt.4)) then
         write(6,*) ' ?vecintrp3d:  ny.lt.4:  ny = ',ny,
     >        'with jspline(2)=',jspline(2)
         ier=1
      endif
c
      if((jspline(3).ge.1).and.(nz.lt.4)) then
         write(6,*) ' ?vecintrp3d:  nz.lt.4:  nz = ',nz,
     >        'with jspline(3)=',jspline(3)
         ier=1
      endif
c
