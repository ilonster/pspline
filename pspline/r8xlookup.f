...
cdbg         if(idbg.gt.0) ilin=0
      else
         ilin=0
         if(xpkg(1,4).gt.2.5_r8) then
            ialg=3
         else if(xpkg(1,4).gt.1.5_r8) then
            ialg=2
         else
            ialg=1
         endif
...
c
      ztola=abs(xpkg(3,4))              ! tolerance for range checking
c
      if(xpkg(3,4).ge.0.0_r8) then
